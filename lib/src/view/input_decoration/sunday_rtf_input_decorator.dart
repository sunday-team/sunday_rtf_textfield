...
// Defines the gap in the RichInputDecorator's outline border where the
...
/// See also:
///
///  * [RichInputDecoration.floatingLabelBehavior] which defines the behavior for
///    [RichInputDecoration.label] or [RichInputDecoration.labelTextSpan].
...
/// See also:
///
///  * [RichInputDecoration.floatingLabelAlignment] which defines the alignment for
///    [RichInputDecoration.label] or [RichInputDecoration.labelTextSpan].
...
class FloatingLabelAlignment {
  ...
  /// Align the floating label on the leading edge of the [RichInputDecorator].
  ///
  ...
  /// Aligns the floating label to the center of an [RichInputDecorator].
...
// An analog of RichInputDecoration for the _Decorator widget.
@immutable
class _Decoration {
  const _Decoration({
...
class _RenderDecoration extends RenderBox
  ...
  double _layoutLineBox(RenderBox? box, BoxConstraints constraints) {
    ...
    assert(() {
      ...
      throw FlutterError.fromParts(<DiagnosticsNode>[
        ErrorSummary(
            "One of RichInputDecorator's children reported a negative baseline offset."),
        ErrorDescription(
  ...
  _RenderDecorationLayout _layout(BoxConstraints layoutConstraints) {
    assert(
      ...
      'An RichInputDecorator, which is typically created by a TextField, cannot '
      'have an unbounded width.\n'
      'This happens when the parent widget does not provide a finite width '
      'constraint. For example, if the RichInputDecorator is contained by a Row, '
      'then its width must be constrained. An Expanded widget or a SizedBox '
      'can be used to constrain the width of the RichInputDecorator or the '
    ...
    // Layout all the widgets used by RichInputDecorator
    ...
    final BoxConstraints contentConstraints = containerConstraints.copyWith(
      maxWidth: math.max(
          0.0, containerConstraints.maxWidth - contentPadding.horizontal),
    );
...
///
/// [RichInputDecorator] displays the visual elements of a Material Design text
/// field around its input [child]. The visual elements themselves are defined
/// by an [RichInputDecoration] object and their layout and appearance depend
/// on the `baseStyle`, `textAlign`, `isFocused`, and `isEmpty` parameters.
///
/// [TextField] uses this widget to decorate its [EditableText] child.
///
/// [RichInputDecorator] can be used to create widgets that look and behave like a
...
class RichInputDecorator extends StatefulWidget {
  ...
  ///
  /// Null [RichInputDecoration] properties are initialized with the corresponding
  /// values from [ThemeData.inputDecorationTheme].
  final RichInputDecoration decoration;
  ...
  /// {@template flutter.material.RichInputDecorator.textAlignVertical}
  ...
  /// See also:
  ///
  ///  * [RichInputDecoration.hoverColor], which is also blended into the focus
  ...
  /// [RichInputDecoration.hoverColor] with [RichInputDecoration.fillColor] when
  /// true, and [RichInputDecoration.fillColor] when not.
  ///
  /// Defaults to false.
  final bool isHovering;
  ...
  @override
  State<RichInputDecorator> createState() => _InputDecoratorState();

  /// The RenderBox that defines this decorator's "container". That's the
  /// area which is filled if [RichInputDecoration.filled] is true. It's the area
  /// adjacent to [RichInputDecoration.icon] and above the widgets that contain
  /// [RichInputDecoration.helperText], [RichInputDecoration.errorText], and
  /// [RichInputDecoration.counterText].
  ///
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
        DiagnosticsProperty<RichInputDecoration>('decoration', decoration));
...
class _InputDecoratorState extends State<RichInputDecorator>
    with TickerProviderStateMixin {
  ...
  RichInputDecoration? _effectiveDecoration;
  RichInputDecoration get decoration => _effectiveDecoration ??=
      widget.decoration.applyDefaults(RTFConverter.convertMaterial2InputDecorationTheme(
  ...
  @override
  void didUpdateWidget(RichInputDecorator old) {
    super.didUpdateWidget(old);
  ...
  Color _getFillColor(ThemeData themeData, InputDecorationTheme defaults) {
    ...
    if (decoration.fillColor != null) {
      return WidgetStateProperty.resolveAs(
          decoration.fillColor!, widgetState);
    }
  ...
  Color _getIconColor(ThemeData themeData, InputDecorationTheme defaults) {
    return WidgetStateProperty.resolveAs(
            decoration.iconColor, widgetState) ??
        WidgetStateProperty.resolveAs(
            themeData.inputDecorationTheme.iconColor, widgetState) ??
  ...
  Color _getPrefixIconColor(
    ...
    return WidgetStateProperty.resolveAs(
            decoration.prefixIconColor, widgetState) ??
        WidgetStateProperty.resolveAs(
            themeData.inputDecorationTheme.prefixIconColor, widgetState) ??
        WidgetStateProperty.resolveAs(
            defaults.prefixIconColor!, widgetState);
  }

  Color _getSuffixIconColor(
      ThemeData themeData, InputDecorationTheme defaults) {
    return WidgetStateProperty.resolveAs(
            decoration.suffixIconColor, widgetState) ??
        WidgetStateProperty.resolveAs(
            themeData.inputDecorationTheme.suffixIconColor, widgetState) ??
        WidgetStateProperty.resolveAs(
            defaults.suffixIconColor!, widgetState);
  }

  // True if the label will be shown and the hint will not.
  // If we're not focused, there's no value, labelTextSpan was provided, and
  ...
  bool get _hasInlineLabel {
    return !widget._labelShouldWithdraw &&
        (decoration.labelTextSpan != null || decoration.label != null) &&
  ...
  TextStyle _getInlineLabelStyle(
    ...
    final TextStyle defaultStyle =
        WidgetStateProperty.resolveAs(defaults.labelStyle!, widgetState);

    final TextStyle? style =
        WidgetStateProperty.resolveAs(decoration.labelStyle, widgetState) ??
            WidgetStateProperty.resolveAs(
                themeData.inputDecorationTheme.labelStyle, widgetState);
  ...
  TextStyle _getInlineHintStyle(
      ThemeData themeData, InputDecorationTheme defaults) {
    final TextStyle defaultStyle =
        WidgetStateProperty.resolveAs(defaults.hintStyle!, widgetState);

    final TextStyle? style =
        WidgetStateProperty.resolveAs(decoration.hintStyle, widgetState) ??
            WidgetStateProperty.resolveAs(
                themeData.inputDecorationTheme.hintStyle, widgetState);
  ...
  TextStyle _getFloatingLabelStyle(
    ...
    TextStyle defaultTextStyle = WidgetStateProperty.resolveAs(
        defaults.floatingLabelStyle!, widgetState);
    ...
    final TextStyle? style = WidgetStateProperty.resolveAs(
            decoration.floatingLabelStyle, widgetState) ??
        WidgetStateProperty.resolveAs(
            themeData.inputDecorationTheme.floatingLabelStyle, widgetState);
  ...
  TextStyle _getHelperStyle(
      ThemeData themeData, InputDecorationTheme defaults) {
    return WidgetStateProperty.resolveAs(defaults.helperStyle!, widgetState)
        .merge(WidgetStateProperty.resolveAs(
            decoration.helperStyle, widgetState));
  }

  TextStyle _getErrorStyle(ThemeData themeData, InputDecorationTheme defaults) {
    return WidgetStateProperty.resolveAs(defaults.errorStyle!, widgetState)
        .merge(decoration.errorStyle);
  }

  Set<WidgetState> get widgetState {
    return <WidgetState>{
      ...
      if (decoration.filled!) {
        return border.copyWith(
          borderSide: WidgetStateProperty.resolveAs(
              defaults.activeIndicatorBorder, widgetState),
        );
      } else {
        return border.copyWith(
          borderSide: WidgetStateProperty.resolveAs(
              defaults.outlineBorder, widgetState),
        );
      }
    } else {
      return border.copyWith(
  ...
  Widget build(BuildContext context) {
    ...
    final TextSpan? hintText = decoration.hintTextSpan;
    final Widget? hint = hintText == null
        ...
        : AnimatedOpacity(
            ...
            child: RichText(
              text: TextSpan(
                style: hintStyle,
                children: decoration.hintTextSpan != null
                    ? [decoration.hintTextSpan!]
                    : null,
              ),
                  ...
                  child: AnimatedDefaultTextStyle(
                    ...
                    child: decoration.label ??
                        RichText(
                          text: TextSpan(
                            style: labelStyle,
                            children: decoration.labelTextSpan != null
                                ? [decoration.labelTextSpan!]
                                : null,
                          ),
                          maxLines: decoration.hintMaxLines,
                          overflow: TextOverflow.ellipsis,
    ...
    final Widget? prefix = hasPrefix
        ? _AffixText(
            ...
            style: WidgetStateProperty.resolveAs(
                    decoration.prefixStyle, widgetState) ??
                hintStyle,
            semanticsSortKey:
    ...
    final Widget? suffix = hasSuffix
        ? _AffixText(
            ...
            style: WidgetStateProperty.resolveAs(
                    decoration.suffixStyle, widgetState) ??
                hintStyle,
            semanticsSortKey:
      ...
      counter = Semantics(
        ...
        child: Text(
          ...
          style: _getHelperStyle(themeData, defaults).merge(
              WidgetStateProperty.resolveAs(
                  decoration.counterStyle, widgetState)),
          overflow: TextOverflow.ellipsis,
...
/// Design text field.
///
/// The [TextField] and [RichInputDecorator] classes use [RichInputDecoration] objects
/// to describe their decoration. (In fact, this class is merely the
/// configuration of an [RichInputDecorator], which does all the heavy lifting.)
///
/// {@tool dartpad}
/// This sample shows how to style a `TextField` using an `RichInputDecorator`. The
...
/// `RichInputDecorator`. The collapsed `TextField` surrounds the hint text and
...
/// message, provide `errorText` to the [RichInputDecoration] constructor.
///
...
class RichInputDecoration {
  ...
  const RichInputDecoration({
    ...
    this.constraints,
  })  : assert(!(label != null && labelTextSpan != null),
            'Declaring both label and labelTextSpan is not supported.'),
  ...
  /// Defines an [RichInputDecorator] that is the same size as the input field.
  ///
  /// This type of input decoration does not include a border by default.
  ///
  /// Sets the [isCollapsed] property to true.
  const RichInputDecoration.collapsed({
    required this.hintTextSpan,
    this.floatingLabelBehavior,
    this.floatingLabelAlignment,
    this.hintStyle,
    this.hintTextDirection,
  ...
  /// otherwise be specified using [labelTextSpan], which only takes one [TextStyle].
  ///
  /// {@tool dartpad}
  ...
  /// {@end-tool}
  ///
  /// Only one of [label] and [labelTextSpan] can be specified.
  final Widget? label;
  ...
  /// Only one of [label] and [labelTextSpan] can be specified.
  final TextSpan? labelTextSpan;

  /// {@template flutter.material.inputDecoration.labelStyle}
  /// The style to use for [RichInputDecoration.labelTextSpan] when the label is on top
  /// of the input field.
  ///
  ...
  /// if the [TextField] is focused or not.
  ///
  /// When the [RichInputDecoration.labelTextSpan] is above (i.e., vertically adjacent to)
  ...
  /// of [RichInputDecoration] that changes the color of the label to the
  /// [RichInputDecoration.errorStyle] color or [ColorScheme.error].
  ///
  /// {@tool dartpad}
  ...
  /// The style to use for [RichInputDecoration.labelTextSpan] when the label is
  /// above (i.e., vertically adjacent to) the input field.
  ///
  /// When the [RichInputDecoration.labelTextSpan] is on top of the input field, the
  ...
  /// Text that provides context about the [RichInputDecorator.child]'s value, such
  /// as how the value will be used.
  ///
  /// If non-null, the text is displayed below the [RichInputDecorator.child], in
  ...
  ///
  /// Displayed on top of the [RichInputDecorator.child] (i.e., at the same location
  /// on the screen where text may be entered in the [RichInputDecorator.child])
  /// when the input [isEmpty] and either (a) [labelTextSpan] is null or (b) the
  /// input has the focus.
  final TextSpan? hintTextSpan;
  ...
  /// if the [TextField] is focused or not.
  ///
  /// Also used for the [labelTextSpan] when the [labelTextSpan] is displayed on
  /// top of the input field (i.e., at the same location on the screen where
  /// text may be entered in the [RichInputDecorator.child]).
  ///
  /// If null, defaults to a value derived from the base [TextStyle] for the
  /// input field and the current [Theme].
  ...
  /// Optional widget that appears below the [RichInputDecorator.child] and the border.
  ///
  ...
  /// Text that appears below the [RichInputDecorator.child] and the border.
  ///
  ...
  /// The style to use for the [RichInputDecoration.errorText].
  ///
  /// If null, defaults of a value derived from the base [TextStyle] for the
  /// input field and the current [Theme].
  ///
  /// By default the color of style will be used by the label of
  /// [RichInputDecoration] if [RichInputDecoration.errorText] is not null. See
  /// [RichInputDecoration.labelStyle] or [RichInputDecoration.floatingLabelStyle] for
  ...
  /// Whether the [RichInputDecorator.child] is part of a dense form (i.e., uses less vertical
  /// space).
  ///
  /// Defaults to false.
  final bool? isDense;
  ...
  ///
  /// A collapsed decoration cannot have [labelTextSpan], [errorText], an [icon].
  ///
  /// To create a collapsed input decoration, use [RichInputDecoration.collapsed].
  final bool? isCollapsed;
  ...
  ///
  /// When [RichInputDecorator.isHovering] is true, the [hoverColor] is also blended
  ...
  ///
  /// If [filled] is false, and [RichInputDecorator.isFocused] is false, the color
  ...
  /// See also:
  ///
  ///  * [RichInputDecorator.isFocused], which is true if the [RichInputDecorator]'s child
  ///    has the focus.
  ...
  ///  * [UnderlineInputBorder], an [RichInputDecorator] border which draws a horizontal
  ///    line at the bottom of the input decorator's container.
  ///  * [OutlineInputBorder], an [RichInputDecorator] border which draws a
  ///    rounded rectangle around the input decorator's container.
  ///  * [InputBorder.none], which doesn't draw a border.
  ///  * [focusedBorder], displayed when [RichInputDecorator.isFocused] is true
  ///    and [RichInputDecoration.errorText] is null.
  ///  * [focusedErrorBorder], displayed when [RichInputDecorator.isFocused] is true
  ///    and [RichInputDecoration.errorText] is non-null.
  ///  * [disabledBorder], displayed when [RichInputDecoration.enabled] is false
  ///    and [RichInputDecoration.errorText] is null.
  ///  * [enabledBorder], displayed when [RichInputDecoration.enabled] is true
  ///    and [RichInputDecoration.errorText] is null.
  ...
  ///    rounded rectangle around the input decorator's container.
  ///  * [InputBorder.none], which doesn't draw a border.
  ///  * [errorBorder], displayed when [RichInputDecorator.isFocused] is false
  ///    and [RichInputDecoration.errorText] is non-null.
  ///  * [focusedErrorBorder], displayed when [RichInputDecorator.isFocused] is true
  ///    and [RichInputDecoration.errorText] is non-null.
  ///  * [disabledBorder], displayed when [RichInputDecoration.enabled] is false
  ...
  /// The decoration's container is the area which is filled if [filled] is
  /// true and bordered per the [border]. It's the area adjacent to
  /// [RichInputDecoration.icon] and above the widgets that contain
  /// [RichInputDecoration.helperText], [RichInputDecoration.errorText], and
  /// [RichInputDecoration.counterText].
  ///
  ...
  /// configured by the RichInputDecorator, depending on the values of
  /// [RichInputDecoration.errorText], [RichInputDecoration.enabled],
  /// [RichInputDecorator.isFocused] and the current [Theme].
  ///
  /// Typically one of [UnderlineInputBorder] or [OutlineInputBorder].
  /// If null, RichInputDecorator's default is `const UnderlineInputBorder()`.
  ///
  /// See also:
  ///
  ///  * [InputBorder.none], which doesn't draw a border.
  ...
  RichInputDecoration copyWith({
    ...
    return RichInputDecoration(
      icon: icon ?? this.icon,
      iconColor: iconColor ?? this.iconColor,
      label: label ?? this.label,
      labelTextSpan: labelTextSpan ?? this.labelTextSpan,
      labelStyle: labelStyle ?? this.labelStyle,
      floatingLabelStyle: floatingLabelStyle ?? this.floatingLabelStyle,
      helperText: helperText ?? this.helperText,
      helperStyle: helperStyle ?? this.helperStyle,
      helperMaxLines: helperMaxLines ?? this.helperMaxLines,
      hintTextSpan: hintTextSpan ?? this.hintTextSpan,
  ...
  /// Used by widgets like [TextField] and [RichInputDecorator] to create a new
  /// [RichInputDecoration] with default values taken from the [theme].
  ///
  /// Only null valued properties from this [RichInputDecoration] are replaced
  /// by the corresponding values from [theme].
  RichInputDecoration applyDefaults(InputDecorationTheme theme) {
    return copyWith(
  ...
  String toString() {
    final List<String> description = <String>[
      ...
      if (labelTextSpan != null) 'labelTextSpan: "$labelTextSpan"',
      if (floatingLabelStyle != null)
        'floatingLabelStyle: "$floatingLabelStyle"',
      if (helperText != null) 'helperText: "$helperText"',
      if (helperMaxLines != null) 'helperMaxLines: "$helperMaxLines"',
      if (hintTextSpan != null) 'hintText: "${hintTextSpan?.text}"',
    ...
    return 'RichInputDecoration(${description.join(', ')})';
  }
}

/// Defines the default appearance of [RichInputDecorator]s.
///
/// This class is used to define the value of [ThemeData.inputDecorationTheme].
/// The [RichInputDecorator], [TextField], and [TextFormField] widgets use
/// the current input decoration theme to initialize null [RichInputDecoration]
/// properties.
///
/// The [RichInputDecoration.applyDefaults] method is used to combine a input
/// decoration theme with an [RichInputDecoration] object.
@immutable
class InputDecorationTheme with Diagnosticable {
  ...
  ///
  /// Defaults to null, which means that the [RichInputDecoration.helperText] will
  ...
  /// See also:
  ///
  ///  * [errorMaxLines], the equivalent but for the [RichInputDecoration.errorText].
  final int? helperMaxLines;

  /// The style to use for the [RichInputDecoration.hintText].
  ///
  /// If [hintStyle] is a [WidgetStateTextStyle], then the effective
  /// text style can depend on the [WidgetState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ///
  /// Also used for the [RichInputDecoration.labelTextSpan] when the
  /// [RichInputDecoration.labelTextSpan] is displayed on top of the input field (i.e.,
  ...
  /// The duration of the [RichInputDecoration.hintText] fade in and fade out animations.
  final Duration? hintFadeDuration;
  ...
  ///
  /// Defaults to null, which means that the [RichInputDecoration.errorText] will be
  ...
  /// See also:
  ///
  ///  * [helperMaxLines], the equivalent but for the [RichInputDecoration.helperText].
  final int? errorMaxLines;
  ...
  /// [RichInputDecoration.filled] is true and bordered per the [border].
  /// It's the area adjacent to [RichInputDecoration.icon] and above the
  /// [RichInputDecoration.icon] and above the widgets that contain
  /// [RichInputDecoration.helperText], [RichInputDecoration.errorText], and
  /// [RichInputDecoration.counterText].
  ///
  ...
  /// Whether the decoration is the same size as the input field.
  ///
  /// A collapsed decoration cannot have [RichInputDecoration.labelTextSpan],
  /// [RichInputDecoration.errorText], or an [RichInputDecoration.icon].
  final bool isCollapsed;
  ...
  /// See also:
  ///
  ///  * [RichInputDecoration.constraints], which can override this setting for a
  ///    given decorator.
  final BoxConstraints? constraints;
...
// BEGIN GENERATED TOKEN PROPERTIES - RichInputDecorator
...
// END GENERATED TOKEN PROPERTIES - RichInputDecorator
