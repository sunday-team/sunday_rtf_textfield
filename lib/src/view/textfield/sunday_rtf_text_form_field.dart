...
class RTFTextFormField extends RichTextFormField {
  @override
  ...
  @override
  FormFieldState<String> createState() => _RTFTextFormFieldState();
}

class _RTFTextFormFieldState extends FormFieldState<String> {
  late RTFTextFieldController controller = _richTextFormField.controller;

  RTFTextFormField get _richTextFormField => super.widget as RTFTextFormField;

  @override
  void didUpdateWidget(RTFTextFormField oldWidget) {
    ...
    return ValueListenableBuilder<TextEditingValue>(
      ...
      builder: (_, controllerValue, __) {
        return RichTextFormField(
          ...
          buildCounters: _richTextFormField.buildCounter,
