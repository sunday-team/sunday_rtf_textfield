...
/// the current context to the [RichInputDecoration], see
/// [RichInputDecoration.applyDefaults].
///
/// For a documentation about the various parameters, see [TextField].
///
/// {@tool snippet}
///
/// Creates a [RichTextFormField] with an [RichInputDecoration] and validator function.
///
...
class RichTextFormField extends FormField<String> {
  ...
  RichTextFormField({
    ...
    String? initialValue,
    FocusNode? focusNode,
    RichInputDecoration? decoration = const RichInputDecoration(),
    ...
    InputCounterWidgetBuilder? buildCounters,
        ...
        super(
          ...
          builder: (FormFieldState<String> field) {
            ...
            final RichInputDecoration effectiveDecoration =
                (decoration ?? const RichInputDecoration()).applyDefaults(
  ...
  /// {@template flutter.material.RichTextFormField.onChanged}
...
class _TextFormFieldState extends FormFieldState<String> {
  ...
  RichTextFormField get _textFormField => super.widget as RichTextFormField;
