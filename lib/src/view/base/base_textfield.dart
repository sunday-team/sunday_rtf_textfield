...
typedef InputCounterWidgetBuilder = Widget? Function(
  /// The build context for the RichTextField.
  BuildContext context, {
  /// The length of the string currently in the input.
  required int currentLength,

  /// The maximum string length that can be entered into the RichTextField.
  required int? maxLength,

  /// Whether or not the RichTextField is currently focused. Mainly provided for
...
/// [RichInputDecoration] surrounds the field in a border using [OutlineInputBorder]
/// and adds a label.
///
...
/// ## Reading values
///
/// A common way to read a value from a RichTextField is to use the [onSubmitted]
/// callback. This callback is applied to the text field's current value when
/// the user finishes editing.
///
/// {@tool dartpad}
/// This sample shows how to get a value from a RichTextField via the [onSubmitted]
/// callback.
///
...
/// callback.
///
/// Keep in mind you can also always read the current string from a RichTextField's
...
///  * [RichInputDecorator], which shows the labels and other visual elements that
...
class RichTextField extends StatefulWidget {
  ...
  const RichTextField({
    ...
    this.focusNode,
    this.undoController,
    this.decoration = const RichInputDecoration(),
    ...
    this.magnifierConfiguration,
        ...
        assert(
          ...
          'Use keyboardType TextInputType.multiline when using TextInputAction.newline on a multiline RichTextField.',
        ),
  ...
  /// will switch to the [decoration]'s [RichInputDecoration.errorStyle] when the
  /// limit is exceeded.
  ///
  ...
  /// [RichInputDecoration.enabled] property.
  final bool? enabled;
  ...
  /// Callback that generates a custom [RichInputDecoration.counter] widget.
  ///
  /// See [InputCounterWidgetBuilder] for an explanation of the passed in
  /// arguments. The returned widget will be placed below the line in place of
  /// the default widget built when [RichInputDecoration.counterText] is specified.
  ///
  ...
  @override
  State<RichTextField> createState() => _TextFieldState();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<RichInputDecoration>(
        'decoration', decoration,
        defaultValue: const RichInputDecoration()));
...
class _TextFieldState extends State<RichTextField>
  ...
  RichInputDecoration _getEffectiveDecoration() {
    final MaterialLocalizations localizations =
        MaterialLocalizations.of(context);
    final ThemeData themeData = Theme.of(context);
    final RichInputDecoration effectiveDecoration =
        (widget.decoration ?? const RichInputDecoration())
            .applyDefaults(
              RTFConverter.convertMaterial2InputDecorationTheme(
  ...
  TextInputConfiguration get textInputConfiguration {
    ...
    final AutofillConfiguration autofillConfiguration = autofillHints != null
        ? AutofillConfiguration(
            ...
            hintText: (widget.decoration ?? const RichInputDecoration())
                .hintTextSpan
                ?.text,
          )
    ...
    switch (theme.platform) {
      ...
      case TargetPlatform.macOS:
        ...
        handleDidGainAccessibilityFocus = () {
          // Automatically activate the RichTextField when it receives accessibility focus.
          if (!_effectiveFocusNode.hasFocus &&
    ...
    Widget child = RepaintBoundary(
      child: UnmanagedRestorationScope(
        ...
        child: EditableText(
          ...
          mouseCursor:
              MouseCursor.defer, // RichTextField will handle the cursor
...
// BEGIN GENERATED TOKEN PROPERTIES - RichTextField
...
// END GENERATED TOKEN PROPERTIES - RichTextField
